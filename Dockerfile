# Build the source
FROM docker.io/library/node:current-alpine3.20 AS builder
...
FROM 201959883603.dkr.ecr.us-east-2.amazonaws.com/mdaca/base-images/ironbank-alpine-nginx:3.20.6_1.26.3
USER root
...
# Configure webserver
COPY --chown=100 ./docker/optimization.conf /etc/nginx/conf.d/optimization.conf
